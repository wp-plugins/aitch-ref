...
<div class="wrap">
	...
	<form method="post">
		...
		<textarea name="urls" cols="60" style="background-image:url(<?php echo $path; ?>/public/ref.jpg);background-repeat:no-repeat;background-position:bottom right; height:377px"><?php echo $urls; ?></textarea>
